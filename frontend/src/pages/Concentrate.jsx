...
const Concentrates = () => {
  ...
  // Filter the concentrate products
  const concentrateProducts = products.filter((product) => product.concentrates === true);

  const filteredProducts = concentrateProducts.filter((product) => {
